...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println();
		System.out.println("4. This is the Black List:");
		...
		//  printing the list
		System.out.println();
		System.out.println("5. This is the stack after trying to add mouse to the top of the stack:");
		Stack.printList();
		
		Stack.addObject(hamster);
		
		//  printing the list
		System.out.println();
		System.out.println("6. This is the stack after trying to add hamster to the top of the stack:");
		Stack.printList();
